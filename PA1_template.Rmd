...
# my strategy will be to use the mean of the relevant segment
...
# this is the result (coincidentally! (or not) the mean and median are forced to be the same using the method choosen)
# this can be demonstrated by sorting the act31 column by steps
act34
